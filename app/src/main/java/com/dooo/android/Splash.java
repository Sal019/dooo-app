            ...
            mFirebaseRemoteConfig.fetchAndActivate()
                    .addOnCompleteListener(this, task -> {
                        if (task.isSuccessful()) {
                            AppConfig.rawUrl = "https://airaflix.pp.ua/";
                            AppConfig.url = "https://airaflix.pp.ua/android/";
